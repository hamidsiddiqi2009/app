...
type LoginData = EmailLoginData | UsernameLoginData | PhoneLoginData | TelegramLoginData;
    ...
    mutationFn: async (credentials: LoginData) => {
      ...
      switch (credentials.method) {
        ...
        case 'telegram':
          ...
          body = { telegram: credentials.telegram, password: credentials.password };
          break;
      }
  ...
  const registerMutation = useMutation({
    ...
    onSuccess: (user: User) => {
      ...
      toast({
        ...
        description: `Welcome to CryptoGrow, ${user.username}!`,
      });
    },
    onError: (error: Error) => {
      toast({
